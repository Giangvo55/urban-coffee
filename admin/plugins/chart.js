! function(t, e) {
    ...
    function g(t) {
        return f(u(2.55 * t), 0, 255)
    }

    function p(t) {
        return f(u(255 * t), 0, 255)
    }

    function m(t) {
        return f(u(t / 2.55) / 100, 0, 1)
    }

    function x(t) {
        return f(u(100 * t), 0, 100)
    }
    const b = /^rgba?\(\s*([-+.\d]+)(%)?[\s,]+([-+.e\d]+)(%)?[\s,]+([-+.e\d]+)(%)?(?:[\s,/]+([-+.e\d]+)(%)?)?\s*\)$/,
        _ = /^(hsla?|hwb|hsv)\(\s*([-+.e\d]+)(?:deg)?[\s,]+([-+.e\d]+)%[\s,]+([-+.e\d]+)%(?:[\s,]+([-+.e\d]+)(%)?)?\s*\)$/;
    ...
    function T(t, e, i) {
        if (t) {
            let n = M(t);
            n[e] = Math.max(0, Math.min(n[e] + n[e] * i, 0 === e ? 360 : 1)), n = S(n), t.r = n[0], t.g = n[1], t.b = n[2]
        }
    }
    ...
    function R(t) {
        return "r" === t.charAt(0) ? function(t) {
            ...
            let i, n = 255;
            if (!e) return;
            e[5] !== i && (n = e[6] ? g(+e[5]) : p(+e[5]));
            const o = P(+e[2]),
                s = +e[3] / 100,
                a = +e[4] / 100;
            return {
                r: (i = "hwb" === e[1] ? k(w, o, s, a) : "hsv" === e[1] ? k(v, o, s, a) : S(o, s, a))[0],
                g: i[1],
                b: i[2],
                a: n
            }
    ...
    class E {
        constructor(t) {
            ...
            let i;
            var n, o, s;
            "object" === e ? i = L(t) : "string" === e && (s = (n = t).length, "#" === n[0] && (4 === s || 5 === s ? o = {
                r: 255 & 17 * r[n[1]],
                g: 255 & 17 * r[n[2]],
                b: 255 & 17 * r[n[3]],
                a: 5 === s ? 17 * r[n[4]] : 255
                ...
                O || ((O = function() {
                    ...
                    for (n = 0; n < e.length; n++) {
                        for (a = r = e[n], o = 0; o < i.length; o++) s = i[o], r = r.replace(s, D[s]);
                        s = parseInt(C[a], 16), t[r] = [s >> 16 & 255, s >> 8 & 255, 255 & s]
                    }
                    return t
                }()).transparent = [0, 0, 0, 0]);
            ...
            }(t) || R(t)), this._rgb = i, this._valid = !!i
        }
        get valid() {
            return this._valid
        }
        ...
        rgbString() {
            return this._valid ? (t = this._rgb) && (t.a < 255 ? `rgba(${t.r}, ${t.g}, ${t.b}, ${m(t.a)})` : `rgb(${t.r}, ${t.g}, ${t.b})`) : this._rgb;
            var t
        }
        hexString() {
            return this._valid ? (t = this._rgb, e = function(t) {
                return d(t.r) && d(t.g) && d(t.b) && d(t.a)
            }(t) ? c : h, t ? "#" + e(t.r) + e(t.g) + e(t.b) + (t.a < 255 ? e(t.a) : "") : t) : this._rgb;
            var t, e
        }
        hslString() {
            return this._valid ? function(t) {
                ...
                const e = M(t),
                    ...
                    n = x(e[1]),
                    o = x(e[2]);
                return t.a < 255 ? `hsla(${i}, ${n}%, ${o}%, ${m(t.a)})` : `hsl(${i}, ${n}%, ${o}%)`
            }(this._rgb) : this._rgb
        }
        mix(t, e) {
            const i = this;
    ...
    function V(t) {
        return z(t) ? t : I(t).saturate(.5).darken(.1).hexString()
    }
    ...
    function Q(t) {
        if (N(t)) return t.map(Q);
        if (j(t)) {
            const e = Object.create(null),
                i = Object.keys(t),
                n = i.length;
            let o = 0;
            for (; o < n; ++o) e[i[o]] = Q(t[i[o]]);
            return e
        }
        return t
    }
    ...
    function nt(t, e, i) {
        ...
        const n = e[t],
            o = i[t];
        j(n) && j(o) ? it(n, o) : Object.prototype.hasOwnProperty.call(e, t) || (e[t] = Q(o))
    }
    ...
    function st(t, e) {
        ...
        let i = 0,
            n = ot(e, i);
        for (; t && n > i;) t = t[e.substr(i, n - i)], n = ot(e, i = n + 1);
        return t
    }
            ...
            Object.defineProperties(o, {
                ...
                [e]: {
                    ...
                    get() {
                        const t = this[a],
                            e = s[n];
                        return j(t) ? Object.assign({}, e, t) : U(t, e)
                    },
                    set(t) {
                        this[a] = t
                    }
    ...
    function St(t) {
        const e = Math.pow(10, Math.floor(Mt(t))),
            i = t / e;
    ...
    function jt(t, e, i, n) {
        ...
        let l, c, h, d, u;
        for (l = 0; l < r; l++)
            if (null != (d = i[l]) && !0 !== N(d)) a = Nt(t, o, s, a, d);
            else if (N(d))
            for (c = 0, h = d.length; c < h; c++) null == (u = d[c]) || N(u) || (a = Nt(t, o, s, a, u));
        t.restore();
        const f = s.length / 2;
        if (f > i.length) {
    ...
    function Qt(t, e, i, n, o, s = {}) {
        ...
        let l, c;
        for (t.save(), s.translation && t.translate(s.translation[0], s.translation[1]), H(s.rotation) || t.rotate(s.rotation), t.font = o.string, s.color && (t.fillStyle = s.color), s.textAlign && (t.textAlign = s.textAlign), s.textBaseline && (t.textBaseline = s.textBaseline), l = 0; l < a.length; ++l) {
            if (c = a[l], r && (s.strokeColor && (t.strokeStyle = s.strokeColor), H(s.strokeWidth) || (t.lineWidth = s.strokeWidth), t.strokeText(c, i, n, s.maxWidth)), t.fillText(c, i, n, s.maxWidth), s.strikethrough || s.underline) {
    ...
    function Jt(t, e) {
        ...
        t.arc(i + a.topLeft, n + a.topLeft, a.topLeft, -yt, pt, !0), t.lineTo(i, n + s - a.bottomLeft), t.arc(i + a.bottomLeft, n + s - a.bottomLeft, a.bottomLeft, pt, yt, !0), t.lineTo(i + o - a.bottomRight, n + s), t.arc(i + o - a.bottomRight, n + s - a.bottomRight, a.bottomRight, yt, 0, !0), t.lineTo(i + o, n + a.topRight), t.arc(i + o - a.topRight, n + a.topRight, a.topRight, 0, -yt, !0), t.lineTo(i + a.topLeft, n)
    }
    ...
    const ee = (t, e, i) => te(t, i, n => t[n][e] < i),
        ie = (t, e, i) => te(t, i, n => t[n][e] >= i);
    ...
    function ae(t, e) {
        ...
        if (!i) return;
        const n = i.listeners,
            o = n.indexOf(e); - 1 !== o && n.splice(o, 1), n.length > 0 || (oe.forEach(e => {
            delete t[e]
        }), delete t._chartjs)
    }
    ...
    function ge(t, e) {
        ...
        } = e, o = he(i), s = "border-box" === o.boxSizing, a = fe(o, "padding"), r = fe(o, "border", "width"), {
            x: l,
            y: c,
            box: h
        } = function(t, e) {
    ...
    function me(t, e, i, n) {
        const o = he(t),
            s = fe(o, "margin"),
            a = ce(o.maxWidth, t, "clientWidth") || bt,
            r = ce(o.maxHeight, t, "clientHeight") || bt,
            l = function(t, e, i) {
                let n, o;
                if (void 0 === e || void 0 === i) {
                    ...
                    if (s) {
                        const t = s.getBoundingClientRect(),
                            ...
                            r = fe(a, "border", "width"),
                            l = fe(a, "padding");
                        e = t.width - l.width - r.width, i = t.height - l.height - r.height, n = ce(a.maxWidth, s, "clientWidth"), o = ce(a.maxHeight, s, "clientHeight")
        ...
        if ("content-box" === o.boxSizing) {
            const t = fe(o, "border", "width"),
                e = fe(o, "padding");
            c -= e.width + t.width, h -= e.height + t.height
        }
        return c = Math.max(0, c - s.width), h = Math.max(0, n ? Math.floor(c / n) : h - s.height), c = pe(Math.min(c, a, l.maxWidth)), h = pe(Math.min(h, r, l.maxHeight)), c && !h && (h = pe(c / 2)), {
            width: c,
            height: h
        }
    }
    ...
    function ve(t, e, i, n) {
        ...
        if (r && e === r.axis && a && s.length) {
            const t = r._reversePixels ? ie : ee;
            if (!n) return t(s, e, i);
            if (o._sharedOptions) {
                const n = s[0],
    ...
    function Me(t, e, i, n) {
        const o = [];
        return Xt(e, t.chartArea, t._minPadding) ? (we(t, i, e, function(t, i, s) {
    ...
    function ke(t, e, i, n, o) {
        ...
        let a = Number.POSITIVE_INFINITY,
            r = [];
        return Xt(e, t.chartArea, t._minPadding) ? (we(t, i, e, function(i, l, c) {
            if (n && !i.inRange(e.x, e.y, o)) return;
            const h = i.getCenterPoint(o);
            if (!Xt(h, t.chartArea, t._minPadding)) return;
            const d = s(e, h);
            d < a ? (r = [{
                element: i,
                datasetIndex: l,
    ...
    var Pe = {
        modes: {
            index(t, e, i, n) {
                const o = ye(e, t),
                    s = i.axis || "x",
                    a = i.intersect ? Me(t, o, s, n) : ke(t, o, s, !1, n),
                    r = [];
            ...
            dataset(t, e, i, n) {
                const o = ye(e, t),
                    s = i.axis || "xy";
                let a = i.intersect ? Me(t, o, s, n) : ke(t, o, s, !1, n);
                if (a.length > 0) {
            ...
            point: (t, e, i, n) => Me(t, ye(e, t), i.axis || "xy", n),
            nearest: (t, e, i, n) => ke(t, ye(e, t), i.axis || "xy", i.intersect, n),
            x: (t, e, i, n) => (i.axis = "x", Se(t, e, i, n)),
            y: (t, e, i, n) => (i.axis = "y", Se(t, e, i, n))
        }
    };
    const De = new RegExp(/^(normal|(\d+(?:\.\d+)?)(px|em|%)?)$/),
        Ce = new RegExp(/^(normal|italic|initial|inherit|unset|(oblique( -?[0-9]?[0-9]deg)?))$/);
    ...
    function Ee(t, e) {
        ...
        let n = U(t.style, e.style);
        n && !("" + n).match(Ce) && (console.warn('Invalid font style specified: "' + n + '"'), n = "");
        const o = {
            family: U(t.family, e.family),
            lineHeight: Oe(U(t.lineHeight, e.lineHeight), i),
            size: i,
            style: n,
            weight: U(t.weight, e.weight),
            string: ""
        };
        return o.string = Ht(o), o
    }

    function Ie(t, e, i, n) {
        let o, s, a, r = !0;
        for (o = 0, s = t.length; o < s; ++o)
            if (void 0 !== (a = t[o]) && (void 0 !== e && "function" == typeof a && (a = a(e), r = !1), void 0 !== i && N(a) && (a = a[i % a.length], r = !1), void 0 !== a)) return n && !r && (n.cacheable = !1), a
    }
    ...
    function ze(t, e) {
        ...
        return {
            min: i - Math.abs(q(e, i)),
            max: n + q(e, n)
        }
    }
    const Fe = ["left", "top", "right", "bottom"];
    ...
    function Be(t, e) {
        return t.filter(t => -1 === Fe.indexOf(t.pos) && t.box.axis === e)
    }
    ...
    function je(t, e, i) {
        const n = i.box,
            o = t.maxPadding;
        j(i.pos) || (i.size && (t[i.pos] -= i.size), i.size = i.horizontal ? n.height : n.width, t[i.pos] += i.size), n.getPadding && Ne(o, n.getPadding());
    ...
    function Ye(t, e, i) {
        ...
        for (o = 0, s = t.length, l = 0; o < s; ++o) {
            (r = (a = t[o]).box).update(a.width || e.w, a.height || e.h, $e(a.horizontal, e));
            const {
                same: s,
                other: h
            } = je(e, i, a);
    ...
    var Xe = {
        ...
        update(t, e, i, n) {
            ...
            ! function(t, e) {
                let i, n, o;
                for (i = 0, n = t.length; i < n; ++i)(o = t[i]).horizontal ? (o.width = o.box.fullSize && e.availableWidth, o.height = e.hBoxMaxHeight) : (o.width = e.vBoxMaxWidth, o.height = o.box.fullSize && e.availableHeight)
    ...
    const ci = t => 0 === t || 1 === t,
        hi = (t, e, i) => -Math.pow(2, 10 * (t -= 1)) * Math.sin((t - e) * mt / i),
        ...
        ui = {
            ...
            easeInOutSine: t => -.5 * (Math.cos(pt * t) - 1),
            ...
            easeInElastic: t => ci(t) ? t : hi(t, .075, .3),
            easeOutElastic: t => ci(t) ? t : di(t, .075, .3),
            easeInOutElastic: t => ci(t) ? t : t < .5 ? .5 * hi(2 * t, .1125, .45) : .5 + .5 * di(2 * t - 1, .1125, .45),
            easeInBack(t) {
                const e = 1.70158;
                return t * t * ((e + 1) * t - e)
            },
    ...
    class pi {
        constructor(t, e, i, n) {
            ...
            this._active = !0, this._fn = t.fn || gi[t.type || typeof s], this._easing = ui[t.easing] || ui.linear, this._start = Math.floor(Date.now() + (t.delay || 0)), this._duration = this._total = Math.floor(t.duration), this._loop = !!t.loop, this._target = e, this._prop = i, this._from = s, this._to = n, this._promises = void 0
        }
        active() {
            return this._active
        }
    ...
    class xi {
        ...
        _createAnimations(t, e) {
            ...
            for (r = s.length - 1; r >= 0; --r) {
                ...
                d && d.duration ? (o[l] = h = new pi(d, t, l, c), n.push(h)) : t[l] = c
            }
            return n
        }
        update(t, e) {
    ...
    function yi(t, e, i, n) {
        ...
        if (null !== e) {
            for (a = 0, r = o.length; a < r; ++a) {
                ...
                c = t.values[l], $(c) && (s || 0 === e || kt(e) === kt(c)) && (e += c)
            }
            return e
        }
    }
    ...
    function ki(t, e) {
        const {
            ...
            return `${s.id}.${e.id}.${i.stack||i.type}`
        }(0, a, n), d = e.length;
        let u;
        for (let t = 0; t < d; ++t) {
            const i = e[t],
            ...
            (u = (i._stacks || (i._stacks = {}))[c] = wi(o, h, n))[r] = s, u._top = Mi(u, a, !0), u._bottom = Mi(u, a, !1)
        }
    }
    ...
    class Oi {
        ...
        initialize() {
            const t = this,
                e = t._cachedMeta;
            t.configure(), t.linkScales(), e._stacked = vi(e.vScale, e), t.addElements()
        }
        updateIndex(t) {
        ...
        linkScales() {
            const t = this,
                ...
                s = i.xAxisID = U(n.xAxisID, Si(e, "x")),
                a = i.yAxisID = U(n.yAxisID, Si(e, "y")),
                r = i.rAxisID = U(n.rAxisID, Si(e, "r")),
                l = i.indexAxis,
        ...
        _destroy() {
            ...
            this._data && ae(this._data, this), t._stacked && Pi(t)
        }
        _dataCheck() {
            const t = this,
                e = t.getDataset(),
            ...
            if (j(i)) t._data = function(t) {
                ...
                i && Object.isExtensible(i) && se(i, t), t._syncList = [], t._data = i
            }
        }
        addElements() {
            const t = this,
        ...
        buildOrUpdateElements(t) {
            ...
            e._dataCheck();
            const s = i._stacked;
            i._stacked = vi(i.vScale, i), i.stack !== n.stack && (o = !0, Pi(i), i.stack = n.stack), e._resyncElements(t), (o || s !== i._stacked) && ki(e, i._parsed)
        }
        configure() {
            const t = this,
                e = t.chart.config,
        ...
        parse(t, e) {
            ...
            if (!1 === i._parsing) n._parsed = o, n._sorted = !0, h = o;
                ...
                h = N(o[t]) ? i.parseArrayData(n, o, t, e) : j(o[t]) ? i.parseObjectData(n, o, t, e) : i.parsePrimitiveData(n, o, t, e);
        ...
        updateRangeFromParsed(t, e, i, n) {
            ...
            n && a && (n.values = a, t.min = Math.min(t.min, s), t.max = Math.max(t.max, s), s = yi(n, o, this._cachedMeta.index, {
                all: !0
        ...
        getMinMax(t, e) {
            ...
            function m() {
                return g = o[u], f = g[t.axis], p = g[r.axis], !$(f) || h > p || d < p
            }
        ...
        getAllParsedValues(t) {
            const e = this._cachedMeta._parsed,
                i = [];
            let n, o, s;
            for (n = 0, o = e.length; n < o; ++n) s = e[n][t.axis], $(s) && i.push(s);
            return i
        }
        getMaxOverflow() {
            return !1
        ...
        _update(t) {
            ...
            e.configure(), e._cachedDataOpts = {}, e.update(t || "default"), i._clip = function(t) {
                let e, i, n, o;
                return j(t) ? (e = t.top, i = t.right, n = t.bottom, o = t.left) : e = i = n = o = t, {
                    top: e,
                    right: i,
                    bottom: n,
                    left: o
                }
            }(U(e.options.clip, function(t, e, i) {
                if (!1 === i) return !1;
                const n = bi(t, i),
                    o = bi(e, i);
                return {
    ...
    Oi.defaults = {}, Oi.prototype.datasetElementType = null, Oi.prototype.dataElementType = null;
    class Ti {
        constructor() {
    ...
    function Vi(t, e, i) {
        ...
        if (!(i && (r = 1 === n ? Math.max(l - s, a - l) : 0 === e ? (t.getPixelForTick(1) - l) / 2 : (l - t.getPixelForTick(o - 1)) / 2, l += o < e ? r : -r, l < s - 1e-6 || l > a + 1e-6))) return l
    }
    ...
    class Ni extends Ti {
        ...
        update(t, e, i) {
            ...
            n._convertTicksToLabels(a ? Fi(n.ticks, s) : n.ticks), n.configure(), n.beforeCalculateLabelRotation(), n.calculateLabelRotation(), n.afterCalculateLabelRotation(), o.display && (o.autoSkip || "auto" === o.source) && (n.ticks = function(t, e) {
                ...
                if (s > 0) {
                    ...
                    for (Ii(e, l, c, H(n) ? 0 : a - n, a), t = 0, i = s - 1; t < i; t++) Ii(e, l, c, o[t], o[t + 1]);
                    return Ii(e, l, c, r, H(n) ? e.length : r + n), l
                }
                return Ii(e, l, c), l
            }(n, n.ticks), n._labelSizes = null), a && n._convertTicksToLabels(n.ticks), n.beforeFit(), n.fit(), n.afterFit(), n.afterUpdate()
        }
        configure() {
            const t = this;
        ...
        generateTickLabels(t) {
            const e = this,
                i = e.options.ticks;
            let n, o, s;
            for (n = 0, o = t.length; n < o; n++)(s = t[n]).label = K(i.callback, [s.value, n, t], e);
            for (n = 0; n < o; n++) H(t[n].label) && (t.splice(n, 1), o--, n--)
        }
        ...
        calculateLabelRotation() {
            ...
            d + 6 > (a = e.offset ? t.maxWidth / n : f / (n - 1)) && (a = f / (n - (e.offset ? .5 : 1)), r = t.maxHeight - Bi(e.grid) - i.padding - Wi(e.title, t.chart.options.font), l = Math.sqrt(d * d + u * u), c = Lt(Math.min(Math.asin(Math.min((h.highest.height + 6) / a, 1)), Math.asin(Math.min(r / l, 1)) - Math.asin(u / l))), c = Math.max(o, Math.min(s, c))), t.labelRotation = c
        }
        ...
        fit() {
            const t = this,
                ...
                r = t.isHorizontal();
            if (a) {
                const a = Wi(o, i.options.font);
                if (r ? (e.width = t.maxWidth, e.height = Bi(s) + a) : (e.height = t.maxHeight, e.width = Bi(s) + a), n.display && t.ticks.length) {
                    const {
                        first: i,
                        last: o,
                        widest: s,
                        highest: a
                    } = t._getLabelSizes(), l = 2 * n.padding, c = At(t.labelRotation), h = Math.cos(c), d = Math.sin(c);
                    if (r) {
        ...
        _getLabelSizes() {
            ...
            if (!e) {
                ...
                let n = t.ticks;
                i < n.length && (n = Fi(n, i)), t._labelSizes = e = t._computeLabelSizes(n, n.length)
            }
            return e
        }
        _computeLabelSizes(t, e) {
            ...
            for (a = 0; a < e; ++a) {
                if (c = t[a].label, h = this._resolveTickFontOptions(a), i.font = d = h.string, u = n[d] = n[d] || {
                        data: {},
                        gc: []
                    }, f = h.lineHeight, g = p = 0, H(c) || N(c)) {
                    if (N(c))
                        for (r = 0, l = c.length; r < l; ++r) H(m = c[r]) || N(m) || (g = Nt(i, u.data, u.gc, g, m), p += f)
        ...
        _computeGridLineItems(t) {
            ...
            for (x = 0; x < c; ++x) {
                ...
                void 0 !== (b = Vi(e, x, r)) && (_ = $t(n, b, i), l ? y = w = k = P = _ : v = M = S = D = _, d.push({
                    tx1: y,
                    ty1: v,
                    tx2: w,
                    ty2: M,
        ...
        _computeLabelItems(t) {
            ...
            for (x = 0, b = r.length; x < b; ++x) {
                y = (_ = r[x]).label;
                const t = s.setContext(e.getContext(x));
                k = e.getPixelForTick(x) + s.labelOffset, P = (S = e._resolveTickFontOptions(x)).lineHeight;
                const i = (D = N(y) ? y.length : 1) / 2,
                    n = t.color,
                    l = t.textStrokeColor,
                    h = t.textStrokeWidth;
                let u;
        ...
        drawBorder() {
            ...
            const a = n.setContext(t.getContext(0)).lineWidth,
                r = t._borderValue;
            let l, c, h, d;
            t.isHorizontal() ? (l = $t(e, t.left, s) - s / 2, c = $t(e, t.right, a) + a / 2, h = d = r) : (h = $t(e, t.top, s) - s / 2, d = $t(e, t.bottom, a) + a / 2, l = c = r), i.save(), i.lineWidth = o.borderWidth, i.strokeStyle = o.borderColor, i.beginPath(), i.moveTo(l, h), i.lineTo(c, d), i.stroke(), i.restore()
        }
        drawLabels(t) {
            const e = this;
            ...
            for (s = 0, a = o.length; s < a; ++s) {
                const t = o[s],
                    e = t.font,
                    n = t.label;
                t.backdrop && (i.fillStyle = t.backdrop.color, i.fillRect(t.backdrop.left, t.backdrop.top, t.backdrop.width, t.backdrop.height)), Qt(i, n, 0, t.textOffset, e, t)
            }
            n && Kt(i)
        }
        drawTitle() {
            ...
            "bottom" === e ? (l += a.bottom, N(i.text) && (l += s.lineHeight * (i.text.length - 1))) : l += a.top;
            const {
                titleX: c,
                titleY: h,
                maxWidth: d,
                ...
                let c, h, d, u = 0;
                return t.isHorizontal() ? (h = o(n, a, l), d = zi(t, i, e), c = l - a) : (h = zi(t, i, e), d = o(n, r, s), u = "left" === i ? -yt : yt), {
                    titleX: h,
                    titleY: d,
                    maxWidth: c,
                    rotation: u
        ...
        _layers() {
            const t = this,
                ...
                n = e.grid && e.grid.z || 0;
            return t._isVisible() && t.draw === Ni.prototype.draw ? [{
                z: n,
                draw(e) {
    ...
    function ji(t, e = [""], i = t, n, o = (() => t[0])) {
        return rt(n) || (n = tn("_fallback", t)), new Proxy({
            ...
            get: (i, n) => qi(i, n, () => (function(t, e, i, n) {
                let o;
                for (const s of e)
                    if (o = tn(Ui(s, t), i), rt(o)) return Xi(t, o) ? Qi(i, n, t, o) : o
            })(n, e, t, i)),
    ...
    function $i(t, e, i, n) {
        ...
        return new Proxy(o, {
            ...
            get: (t, e, i) => qi(t, e, () => (function(t, e, i) {
                const {
                    _proxy: n,
                    _context: o,
                    _subProxy: s,
                ...
                let r = n[e];
                return lt(r) && a.isScriptable(e) && (r = function(t, e, i, n) {
                    const {
                        _proxy: o,
                        _context: s,
                        _subProxy: a,
                    ...
                    return r.add(t), e = e(s, a || n), r.delete(t), j(e) && (e = Qi(o._scopes, o, t, e)), e
                }(e, r, t, i)), N(r) && r.length && (r = function(t, e, i, n) {
                    const {
                        _proxy: o,
                        _context: s,
                        _subProxy: a,
                    ...
                    if (rt(s.index) && n(t)) e = e[s.index % e.length];
                    else if (j(e[0])) {
                        const i = e,
                    ...
                    return e
                }(e, r, t, a.isIndexable)), Xi(e, r) && (r = $i(r, o, s && s[e], a)), r
            })(t, e, i)),
    ...
    function Yi(t, e = {
        ...
        return {
            ...
            isIndexable: lt(n) ? n : () => n
        }
    }
    const Ui = (t, e) => t ? t + at(e) : e,
        Xi = (t, e) => j(e) && "adapters" !== t;

    function qi(t, e, i) {
        let n = t[e];
        return rt(n) || (n = i(), rt(n) && (t[e] = n)), n
    }

    function Ki(t, e, i) {
        return lt(t) ? t(e, i) : t
    }
    const Gi = (t, e) => !0 === t ? e : "string" == typeof t ? st(e, t) : void 0;
    ...
    function Zi(t, e, i, n) {
        for (const o of e) {
            ...
            if (e) {
                ...
                if (rt(o) && o !== i && o !== n) return o
            } else if (!1 === e && rt(n) && i !== n) return null
        }
        return !1
    }
    ...
    function Qi(t, e, i, n) {
        ...
        r.add(n);
        let l = Ji(r, a, i, s || i);
        return null !== l && (!rt(s) || s === i || null !== (l = Ji(r, a, s, l))) && ji([...r], [""], o, s, () => (function(t, e, i) {
    ...
    function rn(t, e = "x") {
        ...
        let a, r, l, c = on(t, 0);
        for (a = 0; a < n; ++a)
            if (r = l, l = c, c = on(t, a + 1), l) {
                if (c) {
                    const t = c[e] - l[e];
                    o[a] = 0 !== t ? (c[i] - l[i]) / t : 0
                }
                s[a] = r ? c ? kt(o[a - 1]) !== kt(o[a]) ? 0 : (o[a - 1] + o[a]) / 2 : o[a - 1] : o[a]
            }! function(t, e, i) {
            const n = t.length;
            let o, s, a, r, l, c = on(t, 0);
            for (let h = 0; h < n - 1; ++h) l = c, c = on(t, h + 1), l && c && (Ct(e[h], 0, nn) ? i[h] = i[h + 1] = 0 : (o = i[h] / e[h], s = i[h + 1] / e[h], (r = Math.pow(o, 2) + Math.pow(s, 2)) <= 9 || (a = 3 / Math.sqrt(r), i[h] = o * a * e[h], i[h + 1] = s * a * e[h])))
        }(t, o, s),
        function(t, e, i = "x") {
            const n = sn(i),
                o = t.length;
            let s, a, r, l = on(t, 0);
            for (let c = 0; c < o; ++c) {
                if (a = r, r = l, l = on(t, c + 1), !r) continue;
                const o = r[i],
                    h = r[n];
    ...
    function cn(t, e, i, n, o) {
        let s, a, r, l;
        if (e.spanGaps && (t = t.filter(t => !t.skip)), "monotone" === e.cubicInterpolationMode) rn(t, o);
        else {
            let i = n ? t[t.length - 1] : t[0];
            for (s = 0, a = t.length; s < a; ++s) l = an(i, r = t[s], t[Math.min(s + 1, a - (n ? 0 : 1)) % a], e.tension), r.cp1x = l.previous.x, r.cp1y = l.previous.y, r.cp2x = l.next.x, r.cp2y = l.next.y, i = r
        }
        e.capBezierPoints && function(t, e) {
            let i, n, o, s, a, r = Xt(t[0], e);
            for (i = 0, n = t.length; i < n; ++i) a = s, s = r, r = i < n - 1 && Xt(t[i + 1], e), s && (o = t[i], a && (o.cp1x = ln(o.cp1x, e.left, e.right), o.cp1y = ln(o.cp1y, e.top, e.bottom)), r && (o.cp2x = ln(o.cp2x, e.left, e.right), o.cp2y = ln(o.cp2y, e.top, e.bottom)))
        }(t, i)
    }
    ...
    function bn(t, e, i) {
        ...
        const y = () => b || l(o, x, p) && 0 !== r(o, x),
            v = () => !b || 0 === r(s, p) || l(s, x, p);
        for (let t = h, i = h; t <= d; ++t)(m = e[t % a]).skip || (p = c(m[n])) !== x && (b = l(p, o, s), null === _ && y() && (_ = 0 === r(p, o) ? t : i), null !== _ && v() && (g.push(xn({
            start: _,
            end: t,
            loop: u,
            count: a,
    ...
    var kn = Object.freeze({
        ...
        _getParentNode: le,
        getStyle: de,
        getRelativePosition: ge,
        getMaximumSize: me,
        retinaScale: xe,
        supportsEventListenerOptions: be,
        readUsedSize: _e,
        ...
        almostEquals: Ct,
        almostWhole: Ot,
        _setMinAndMaxByKey: Tt,
        toRadians: At,
        toDegrees: Lt,
        _decimalPlaces: Rt,
        getAngleFromPoint: Et,
        distanceBetweenPoints: It,
        _angleDiff: zt,
        _normalizeAngle: Ft,
        _angleBetween: Vt,
        _limitValue: Bt,
    ...
    class Sn {
        ...
        register(t) {
            ...
            let n;
            "id" in i && "defaults" in i && (n = e.register(i));
            const o = e.items,
                s = t.id,
                a = e.scope + "." + s;
            if (!s) throw new Error("class does not have id: " + t);
            return s in o || (o[s] = t, function(t, e, i) {
                const n = et(Object.create(null), [i ? gt.get(i) : {}, gt.get(e), t.defaults]);
                gt.set(e, n), t.defaultRoutes && function(t, e) {
            ...
            }(t, a, n), e.override && gt.override(t.id, t.overrides)), a
        }
        get(t) {
            return this.items[t]
        }
        unregister(t) {
            const e = this.items,
                i = t.id,
                n = this.scope;
            i in e && delete e[i], n && i in gt[n] && (delete gt[n][i], this.override && delete ht[i])
        }
    }
    var Pn = new class {
        constructor() {
            this.controllers = new Sn(Oi, "datasets", !0), this.elements = new Sn(Ti, "elements"), this.plugins = new Sn(Object, "plugins"), this.scales = new Sn(Ni, "scales"), this._typedRegistries = [this.controllers, this.scales, this.elements]
        }
        add(...t) {
        ...
        _each(t, e, i) {
            ...
            [...e].forEach(e => {
                ...
                i || o.isForType(e) || o === n.plugins && e.id ? n._exec(t, o, e) : G(e, e => {
                    const o = i || n._getRegistryForType(e);
                    n._exec(t, o, e)
                })
            })
        ...
        e.plugins = U(e.plugins, {}), e.scales = function(t, e) {
            ...
            return Object.keys(n).forEach(t => {
                const e = n[t],
                    r = An(t, e),
                    l = function(t, e) {
                        return r === o ? "_index_" : "_value_"
                    }(),
                    c = i.scales || {};
                s[r] = s[r] || t, a[t] = it(Object.create(null), [{
                    axis: r
                }, e, c[r], c[l]])
            }), t.data.datasets.forEach(i => {
                const o = i.type || t.type,
                    r = i.indexAxis || Tn(o, e),
                    l = (ht[o] || {}).scales || {};
                Object.keys(l).forEach(t => {
                    const e = function(t, e) {
                            let i = t;
                            return "_index_" === t ? i = r : "_value_" === t && (i = "x" === r ? "y" : "x"), i
                        }(t),
                        o = i[e + "AxisID"] || s[e] || e;
                    a[o] = a[o] || Object.create(null), it(a[o], [{
                        axis: e
                    }, n[o], l[t]])
                })
            }), Object.keys(a).forEach(t => {
                const e = a[t];
                it(e, [gt.scales[e.type], gt.scale])
            }), a
        }(t, e)
    }
    ...
    function zn(t, e) {
        let i = En.get(t);
        return i || (i = e(), En.set(t, i), In.add(i)), i
    }
    const Fn = (t, e, i) => {
        const n = st(e, i);
        void 0 !== n && t.add(n)
    ...
    class Vn {
        constructor(t) {
            this._config = function(t) {
                return (t = t || {}).data = Rn(t.data), Ln(t), t
        ...
        getOptionScopes(t, e, i) {
            ...
            const r = new Set;
            e.forEach(e => {
                t && (r.add(t), e.forEach(e => Fn(r, t, e))), e.forEach(t => Fn(r, n, t)), e.forEach(t => Fn(r, ht[o] || {}, t)), e.forEach(t => Fn(r, gt, t)), e.forEach(t => Fn(r, dt, t))
            });
            const l = [...r];
            return In.has(e) && s.set(e, l), l
        }
        chartOptionScopes() {
            const {
                options: t,
        ...
        resolveNamedOptions(t, e, i, n = [""]) {
            ...
            (function(t, e) {
                ...
                for (const o of e)
                    if (i(o) && lt(t[o]) || n(o) && N(t[o])) return !0;
                return !1
            })(s, e) && (o.$shared = !1, r = $i(s, i = lt(i) ? i() : i, this.createResolver(t, i, a)));
    ...
    const Wn = ["top", "bottom", "left", "right", "chartArea"];

    function Hn(t, e) {
        return "top" === t || "bottom" === t || -1 === Wn.indexOf(t) && "x" === e
    }
    ...
    function Un(t) {
        return Yn() && "string" == typeof t ? t = document.getElementById(t) : t && t.length && (t = t[0]), t && t.canvas && (t = t.canvas), t
    }
    const Xn = {},
        qn = t => {
            const e = Un(t);
            return Object.values(Xn).filter(t => t.canvas === e).pop()
        };
    class Kn {
        constructor(t, e) {
            const n = this;
            this.config = e = new Vn(e);
            const o = Un(t),
                s = qn(o);
            ...
            const l = n.platform.acquireContext(o, r.aspectRatio),
                ...
                h = c && c.height,
                d = c && c.width;
            this.id = W(), this.ctx = l, this.canvas = c, this.width = d, this.height = h, this._options = r, this._aspectRatio = this.aspectRatio, this._layers = [], this._metasets = [], this._stacks = void 0, this.boxes = [], this.currentDevicePixelRatio = void 0, this.chartArea = void 0, this._active = [], this._lastEvent = void 0, this._listeners = {}, this._responsiveListeners = void 0, this._sortedMetasets = [], this.scales = {}, this.scale = void 0, this._plugins = new Dn, this.$proxies = {}, this._hiddenIndices = {}, this.attached = !1, this._animationsDisabled = void 0, this.$context = void 0, this._doResize = i(() => this.update("resize"), r.resizeDelay || 0), Xn[n.id] = n, l && c ? (a.listen(n, "complete", jn), a.listen(n, "progress", $n), n._initialize(), n.attached && n.update()) : console.error("Failed to create chart: can't acquire context from the given item")
        }
        get aspectRatio() {
            const {
                options: {
        ...
        _initialize() {
            const t = this;
            return t.notifyPlugins("beforeInit"), t.options.responsive ? t.resize() : xe(t, t.options.devicePixelRatio), t.bindEvents(), t.notifyPlugins("afterInit"), t
        }
        _initializePlatform(t, e) {
            return e.platform ? new e.platform : !Yn() || "undefined" != typeof OffscreenCanvas && t instanceof OffscreenCanvas ? new Ke : new ri
        }
        clear() {
        ...
        _resize(t, e) {
            ...
            i.width = a.width, i.height = a.height, i._aspectRatio = i.aspectRatio, xe(i, r, !0) && (i.notifyPlugins("resize", {
                size: a
            }), K(n.onResize, [i, a], i), i.attached && i._doResize() && i.render())
        }
        ensureScalesHaveIDs() {
        ...
        buildOrUpdateScales() {
            ...
            i && (s = s.concat(Object.keys(i).map(t => {
                ...
                let c = null;
                a in n && n[a].type === l ? c = n[a] : (c = new(Pn.getScale(l))({
                    id: a,
                    type: l,
                    ctx: t.ctx,
                    chart: t
        ...
        buildOrUpdateControllers() {
            ...
            for (t._removeUnreferencedMetasets(), n = 0, o = i.length; n < o; n++) {
                ...
                if (s.type && s.type !== a && (t._destroyDatasetMeta(n), s = t.getDatasetMeta(n)), s.type = a, s.indexAxis = o.indexAxis || Tn(a, t.options), s.order = o.order || 0, s.index = n, s.label = "" + o.label, s.visible = t.isDatasetVisible(n), s.controller) s.controller.updateIndex(n), s.controller.linkScales();
                else {
        ...
        update(t) {
            const e = this,
                i = e.config;
            i.update(), e._options = i.createResolver(i.chartOptionScopes(), e.getContext()), G(e.scales, t => {
                Xe.removeBox(e, t)
            });
            ...
            if (ct(o, s) && !!this._responsiveListeners === e.options.responsive || (e.unbindEvents(), e.bindEvents()), e._plugins.invalidate(), !1 === e.notifyPlugins("beforeUpdate", {
                    mode: t,
                    cancelable: !0
                })) return;
            ...
            e._minPadding = r, e._updateLayout(r), n || G(a, t => {
                t.reset()
            }), e._updateDatasets(t), e.notifyPlugins("afterUpdate", {
                mode: t
            }), e._layers.sort(Nn("z", "_idx")), e._lastEvent && e._eventHandler(e._lastEvent, !0), e.render()
        }
        _updateLayout(t) {
            const e = this;
        ...
        _drawDataset(t) {
            ...
            !1 !== e.notifyPlugins("beforeDatasetDraw", s) && (qt(i, {
            ...
            }), t.controller.draw(), Kt(i), s.cancelable = !1, e.notifyPlugins("afterDatasetDraw", s))
        }
        ...
        destroy() {
            ...
            t.config.clearCache(), e && (t.unbindEvents(), Yt(e, i), t.platform.releaseContext(i), t.canvas = null, t.ctx = null), t.notifyPlugins("destroy"), delete Xn[t.id]
        }
        toBase64Image(...t) {
        ...
        unbindEvents() {
            ...
            }), t._listeners = {}, G(t._responsiveListeners, (e, i) => {
                t.platform.removeEventListener(t, i, e)
        ...
        setActiveElements(t) {
            ...
            !Z(n, i) && (e._active = n, e._updateHoverStyles(n, i))
        }
        notifyPlugins(t, e, i) {
        ...
        _handleEvent(t, e) {
            ...
            let r = [],
                l = !1,
                c = null;
            return "mouseout" !== t.type && (r = i.getElementsAtEventForMode(t, s.mode, s, a), c = "click" === t.type ? i._lastEvent : t), i._lastEvent = null, Xt(t, i.chartArea, i._minPadding) && (K(o.onHover, [t, r, i], i), "mouseup" !== t.type && "click" !== t.type && "contextmenu" !== t.type || K(o.onClick, [t, r, i], i)), ((l = !Z(r, n)) || e) && (i._active = r, i._updateHoverStyles(r, n, e)), i._lastEvent = c, l
        }
    }
    const Gn = () => G(Kn.instances, t => t._plugins.invalidate());
    ...
    function to(t) {
        const e = function(t) {
            if (!t._cache.$bar) {
                ...
                t._cache.$bar = re(i.sort((t, e) => t - e))
            }
            return t._cache.$bar
        }(t);
        let i, n, o, s, a = t._length;
        const r = () => {
            32767 !== o && -32768 !== o && (rt(s) && (a = Math.min(a, Math.abs(o - s) || a)), s = o)
        };
    ...
    function io(t, e, i, n) {
        const o = t.iScale,
            ...
            l = [];
        let c, h, d, u;
        for (c = i, h = i + n; c < h; ++c) u = e[c], (d = {})[o.axis] = r || o.parse(a[c], c), l.push(eo(u, d, s, c));
        return l
    }
    ...
    class oo extends Oi {
        ...
        parseObjectData(t, e, i, n) {
            ...
            let d, u, f, g;
            for (d = i, u = i + n; d < u; ++d) g = e[d], (f = {})[o.axis] = o.parse(st(g, l), d), h.push(eo(st(g, c), f, s, d));
            return h
        }
        updateRangeFromParsed(t, e, i, n) {
        ...
        getLabelAndValue(t) {
            const e = this._cachedMeta,
                ...
                o = this.getParsed(t),
                s = o._custom,
                a = no(s) ? "[" + s.start + ", " + s.end + "]" : "" + n.getLabelForValue(o[n.axis]);
            return {
            ...
            for (let h = e; h < e + i; h++) {
                const e = o.getParsed(h),
                    ...
                    p = {
                        horizontal: l,
                        base: i.base,
                        enableBorderRadius: !g || no(e._custom) || o.index === g._top || o.index === g._bottom,
                        x: l ? i.head : f.center,
                        y: l ? f.center : i.head,
        ...
        _calculateBarValuePixels(t) {
            ...
            f !== d && (u = f - d, f = d), l && (d = r.barStart, f = r.barEnd - r.barStart, 0 !== d && kt(d) !== kt(r.barEnd) && (u = 0), u += d);
            const g = H(o) || l ? u : o;
            let p = i.getPixelForValue(g);
            h = (c = this.chart.getDataVisibility(t) ? i.getPixelForValue(u + f) : p) - p, void 0 !== s && Math.abs(h) < s && (h = h < 0 ? -s : s, 0 === d && (p -= h / 2), c = p + h);
            const m = o || 0;
        ...
        draw() {
            const t = this,
                ...
                s = o.length;
            let a = 0;
            for (qt(e.ctx, e.chartArea); a < s; ++a) null !== t.getParsed(a)[n.axis] && o[a].draw(t._ctx);
            Kt(e.ctx)
        }
    }
    ...
    class so extends Oi {
        ...
        resolveDataElementOptions(t, e) {
            ...
            const o = n.radius;
            return "active" !== e && (n.radius = 0), n.radius += U(i && i._custom, o), n
        }
    }
    ...
    class ao extends Oi {
        ...
        update(t) {
            const e = this,
                ...
                l = Math.min(X(e.options.cutout, r), 1),
                ...
                } = e._getRotationExtents(),
                {
                    ...
                    if (l < mt) {
                        const t = c,
                            ...
                            c = Math.cos(e),
                            h = Math.sin(e),
                            d = (n, o, s) => Vt(n, t, e, !0) ? 1 : Math.max(o, o * i, s, s * i),
                            u = (n, o, s) => Vt(n, t, e, !0) ? -1 : Math.min(o, o * i, s, s * i),
                            f = d(0, r, c),
                            g = d(yt, l, h),
                            p = u(pt, r, c),
                            m = u(pt + yt, l, h);
                        n = (f - p) / 2, o = (g - m) / 2, s = -(f + p) / 2, a = -(g + m) / 2
                    }
                    return {
                        ratioX: n,
                        ratioY: o,
        ...
        _circumference(t, e) {
            ...
            return e && n.animation.animateRotate || !this.chart.getDataVisibility(t) || null === o._parsed[t] ? 0 : i.calculateCircumference(o._parsed[t] * s / mt)
        }
        updateElements(t, e, i, n) {
            const o = this,
                s = "reset" === n,
            ...
            tooltip: {
                callbacks: {
                    ...
                    label(t) {
                        ...
                        return N(e) ? (e = e.slice())[0] += i : e += i, e
                    }
                }
            }
        }
    ...
    class ro extends Oi {
        ...
        update(t) {
            ...
            let {
                ...
                if (t._sorted) {
                    ...
                    d && (o = Bt(Math.min(ee(r, a.axis, c).lo, i ? n : ee(e, l, a.getPixelForValue(c)).lo), 0, n - 1)), s = u ? Bt(Math.max(ee(r, a.axis, h).hi + 1, i ? 0 : ee(e, l, a.getPixelForValue(h)).hi + 1), o, n) - o : n - o
                }
                return {
                    start: o,
                    count: s
        ...
        updateElements(t, e, i, n) {
            const o = this,
                ...
                p = Dt(g) ? g : Number.POSITIVE_INFINITY,
    ...
    class lo extends Oi {
        ...
        getLabelAndValue(t) {
            const e = this._cachedMeta,
                i = this.chart,
                n = i.data.labels || [],
                o = Li(e._parsed[t].r, i.options.locale);
            return {
                label: n[t] || "",
                value: o
            }
    ...
    function go(t, e, i) {
        ...
        let c = o / r;
        t.beginPath(), t.arc(s, a, r, n - c, i + c), l > o ? (c = o / l, t.arc(s, a, l, i + c, n - c, !0)) : t.arc(s, a, o, i + yt, n - yt), t.closePath(), t.clip()
    }
    ...
    function mo(t, e, i, n) {
        const {
            ...
            pixelMargin: r,
            innerRadius: l
        } = e, c = Math.max(e.outerRadius + i - r, 0), h = l > 0 ? l + i + r : 0, d = n - a, u = (d - Math.max(.001, d * c - i / pt) / c) / 2, f = a + u, g = n - u, {
            outerStart: p,
            outerEnd: m,
            innerStart: x,
            innerEnd: b
        } = function(t, e, i, n) {
            const o = Te(t.options.borderRadius, ["outerStart", "outerEnd", "innerStart", "innerEnd"]),
                s = (i - e) / 2,
                a = Math.min(s, n * e / 2),
                r = t => {
                    const e = (i - Math.min(s, t)) * n / 2;
                    return Bt(t, 0, Math.min(s, e))
                };
            return {
                outerStart: r(o.outerStart),
                outerEnd: r(o.outerEnd),
                innerStart: Bt(o.innerStart, 0, a),
                innerEnd: Bt(o.innerEnd, 0, a)
            }
        }(e, h, c, g - f), _ = c - p, y = c - m, v = f + p / _, w = g - m / y, M = h + x, k = h + b, S = f + x / M, P = g - b / k;
        if (t.beginPath(), t.arc(o, s, c, v, w), m > 0) {
            const e = po(y, w, o, s);
            t.arc(e.x, e.y, m, w, g + yt)
        }
        const D = po(k, g, o, s);
        if (t.lineTo(D.x, D.y), b > 0) {
            const e = po(k, P, o, s);
            t.arc(e.x, e.y, b, g + yt, P + Math.PI)
        }
        if (t.arc(o, s, h, g - b / h, f + x / h, !0), x > 0) {
            const e = po(M, S, o, s);
            t.arc(e.x, e.y, x, S + Math.PI, f - yt)
        }
        const C = po(_, f, o, s);
        if (t.lineTo(C.x, C.y), p > 0) {
            const e = po(_, v, o, s);
            t.arc(e.x, e.y, p, f - yt, v)
        }
        t.closePath()
    }
    class xo extends Ti {
        ...
        draw(t) {
            const e = this,
                ...
                o = (i.offset || 0) / 2;
            if (e.pixelMargin = "inner" === i.borderAlign ? .33 : 0, e.fullCircles = n > mt ? Math.floor(n / mt) : 0, 0 === n || e.innerRadius < 0 || e.outerRadius < 0) return;
            t.save();
            let s = 0;
            if (o) {
                s = o / 2;
                const i = (e.startAngle + e.endAngle) / 2;
                t.translate(Math.cos(i) * s, Math.sin(i) * s), e.circumference >= pt && (s = o)
            }
            ...
            (function(t, e, i, n) {
                ...
                o.borderWidth && (s ? (t.lineWidth = 2 * o.borderWidth, t.lineJoin = "round") : (t.lineWidth = o.borderWidth, t.lineJoin = "bevel"), e.fullCircles && function(t, e, i) {
                    ...
                    let h;
                    for (i && go(t, e, s + mt), t.beginPath(), t.arc(n, o, c, s + mt, s, !0), h = 0; h < r; ++h) t.stroke();
                    for (t.beginPath(), t.arc(n, o, l, s, s + mt), h = 0; h < r; ++h) t.stroke()
                }(t, e, s), s && go(t, e, n), mo(t, e, i, n), t.stroke())
            })(t, e, s, a), t.restore()
        }
    }
    ...
    function vo(t, e, i, n) {
        const {
            ...
            loop: l,
            ilen: c
        } = yo(o, i, n), h = function(t) {
            return t.stepped ? Gt : t.tension || "monotone" === t.cubicInterpolationMode ? Zt : _o
        }(s);
        let d, u, f, {
            move: g = !0,
            reverse: p
    ...
    function Mo(t) {
        ...
        return t._decimated || t._loop || e.tension || "monotone" === e.cubicInterpolationMode || e.stepped || i ? vo : wo
    }
    xo.id = "arc", xo.defaults = {
        borderAlign: "center",
        borderColor: "#fff",
        borderRadius: 0,
        borderWidth: 2,
    ...
    const ko = "function" == typeof Path2D;
    class So extends Ti {
        constructor(t) {
        ...
        updateControlPoints(t, e) {
            ...
            if ((n.tension || "monotone" === n.cubicInterpolationMode) && !n.stepped && !i._pointsUpdated) {
                ...
                cn(i._points, n, t, o, e), i._pointsUpdated = !0
            }
        }
        set points(t) {
            const e = this;
        ...
        interpolate(t, e) {
            ...
            const r = [],
                l = function(t) {
                    return t.stepped ? dn : t.tension || "monotone" === t.cubicInterpolationMode ? un : hn
                }(n);
            let c, h;
        ...
        draw(t, e, i, n) {
            const o = this,
                s = o.options || {};
            (o.points || []).length && s.borderWidth && (t.save(), function(t, e, i, n) {
                ko && 1 === e.segments.length ? function(t, e, i, n) {
                    let o = e._path;
                    o || (o = e._path = new Path2D, e.path(o, i, n) && o.closePath()), bo(t, e.options), t.stroke(o)
                }(t, e, i, n) : function(t, e, i, n) {
                    const {
                        segments: o,
                        options: s
                    } = e, a = Mo(e);
                    for (const r of o) bo(t, s, r.style), t.beginPath(), a(t, e, r, {
                        start: i,
                        end: i + n - 1
                    }) && t.closePath(), t.stroke()
                }(t, e, i, n)
            }(t, o, i, n), t.restore(), o.animated && (o._pointsUpdated = !1, o._path = void 0))
        }
    }
    ...
    class Do extends Ti {
        ...
        draw(t) {
            const e = this,
                i = e.options;
            e.skip || i.radius < .1 || (t.strokeStyle = i.borderColor, t.lineWidth = i.borderWidth, t.fillStyle = i.backgroundColor, Ut(t, i, e.x, e.y))
        }
        getRange() {
    ...
    function Oo(t) {
        ...
        const i = {};
        return e ? (i[e = t.horizontal ? To(e, "left", "right", t.base > t.x) : To(e, "bottom", "top", t.base < t.y)] = !0, i) : i
    }

    function To(t, e, i, n) {
        var o, s, a;
        return n ? (a = i, t = Ao(t = (o = t) === (s = e) ? a : o === a ? s : o, i, e)) : t = Ao(t, e, i), t
    }
            ...
            const e = this.options,
                {
                    ...
                    const e = Co(t),
                        ...
                        s = function(t, e, i) {
                            ...
                            } = t.getProps(["enableBorderRadius"]), o = t.options.borderRadius, s = Le(o), a = Math.min(e, i), r = Oo(t), l = n || j(o);
                            return {
                ...
                o = (s = n.radius).topLeft || s.topRight || s.bottomLeft || s.bottomRight ? Jt : Eo;
            var s;
        ...
        beforeElementsUpdate: (t, e, i) => {
            ...
            t.data.datasets.forEach((e, o) => {
                ...
                let h, {
                    ...
                    return l && (o = Bt(ee(e, s.axis, a).lo, 0, i - 1)), {
                        start: o,
                        count: n = c ? Bt(ee(e, s.axis, r).hi + 1, o, i) - o : i - o
                    }
                }(r, l);
                if (u <= 4 * n) Fo(e);
                else {
                        ...
                        case "lttb":
                            h = function(t, e, i, n, o) {
                                ...
                                for (a[l++] = t[p], h = 0; h < s - 2; h++) {
                                    ...
                                    for (u = f = -1, n = b; n < _; n++)(f = .5 * Math.abs((y - o) * (t[n].y - v) - (y - t[n].x) * (s - v))) > u && (u = f, d = t[n], g = n);
                                    a[l++] = d, p = g
                                }
                                return a[l++] = t[c], a
                            }(l, d, u, n, i);
    ...
    function Wo(t, e, i) {
        ...
        if (j(n)) return !isNaN(n.value) && n;
        let o = parseFloat(n);
        return $(o) && Math.floor(o) === o ? ("-" !== n[0] && "+" !== n[0] || (o = e + o), !(o === e || o < 0 || o >= i) && o) : ["origin", "start", "end", "stack"].indexOf(n) >= 0 && n
    }
    class Ho {
        constructor(t) {
    ...
    const No = t => "line" === t.type && !t.hidden;
    ...
    function Yo(t, e) {
        let i = [],
            n = !1;
        return N(t) ? (n = !0, i = t) : i = function(t, e) {
            const {
                x: i = null,
                y: n = null
            } = t || {}, o = e.points, s = [];
    ...
    function Qo(t, e) {
        const {
            ...
            const n = t.segments,
                ...
                a = [];
            for (const t of n) {
                const n = qo(i, o[t.start], o[t.end], t.loop);
                if (!e.segments) {
                    a.push({
                        source: t,
                        target: n,
                ...
                const r = _n(e, n);
                for (const e of r) {
                    const r = qo(i, s[e.start], s[e.end], e.loop),
                        l = bn(t, o, r);
                    for (const t of l) a.push({
                        source: t,
                        target: e,
                        start: {
                            [i]: Ko(n, r, "start", Math.max)
                        },
                        end: {
                            [i]: Ko(n, r, "end", Math.min)
                        }
                    })
                }
            }
        ...
        for (const {
            ...
            t.save(), t.fillStyle = r, Go(t, a, qo(o, c, h)), t.beginPath();
            const d = !!i.pathSegment(t, e);
            d ? t.closePath() : Zo(t, n, h, o);
            const u = !!n.pathSegment(t, l, {
                    move: d,
                    reverse: !0
                }),
                f = d && u;
            f || Zo(t, n, c, o), t.closePath(), t.fill(f ? "evenodd" : "nonzero"), t.restore()
        }
    }
    ...
    function Jo(t, e, i) {
        const n = function(t) {
                ...
                if ("stack" === i) return function(t) {
                    ...
                    for (let t = 0; t < a.length; t++) {
                        const e = a[t];
                        for (let t = e.start; t <= e.end; t++) jo(s, r[t], l)
                    }
                    return new So({
                        points: s,
                        options: {}
                ...
                const o = function(t) {
                    return (t.scale || {}).getPointPositionForValue ? function(t) {
                        ...
                        let l, c, h;
                        if (h = "start" === i ? a : "end" === i ? r : j(i) ? i.value : e.getBaseValue(), n.grid.circular) return c = e.getPointPositionForValue(0, a), new Ho({
                            x: c.x,
                            y: c.y,
                        ...
                        let n, o = null;
                        return "start" === i ? o = e.bottom : "end" === i ? o = e.top : j(i) ? o = e.getPixelForValue(i.value) : e.getBasePixel && (o = e.getBasePixel()), $(o) ? {
                            x: (n = e.isHorizontal()) ? o : null,
                            y: n ? null : o
                        } : null
                    }(t)
                }(t);
                return o instanceof Ho ? o : Yo(o, n)
            }(e),
            {
                line: o,
                scale: s,
        ...
        n && o.points.length && (qt(t, i), function(t, e) {
            const {
                line: i,
                target: n,
                above: o,
            ...
            t.save(), "x" === l && s !== o && (Xo(t, n, a.top), Qo(t, {
                line: i,
                target: n,
                color: o,
                scale: r,
                property: l
            }), t.restore(), t.save(), Xo(t, n, a.bottom)), Qo(t, {
                line: i,
                target: n,
                color: s,
                scale: r,
    ...
    var ts = {
        ...
        afterDatasetsUpdate(t, e, i) {
            const n = (t.data.datasets || []).length,
                o = [];
            let s, a, r, l;
            for (a = 0; a < n; ++a) l = null, (r = (s = t.getDatasetMeta(a)).dataset) && r.options && r instanceof So && (l = {
            ...
            for (a = 0; a < n; ++a)(l = o[a]) && !1 !== l.fill && (l.fill = Uo(o, a, i.propagate))
        },
        beforeDraw(t, e, i) {
        ...
        beforeDatasetDraw(t, e, i) {
            ...
            n && !1 !== n.fill && "beforeDatasetDraw" === i.drawTime && Jo(t.ctx, n, t.chartArea)
        },
        defaults: {
            propagate: !0,
    ...
    class is extends Ti {
        ...
        _draw() {
            ...
            const {
                ...
                boxHeight: b,
                itemHeight: _
            } = es(l, g), y = t.isHorizontal(), v = this._computeTitleHeight();
            m = y ? {
            ...
            t.legendItems.forEach((e, M) => {
                ...
                h.setWidth(t.width), y ? M > 0 && D + P + f > t.right && (C = m.y += w, m.line++, D = m.x = o(r, t.left + f, t.right - n[m.line])) : M > 0 && C + w > t.bottom && (D = m.x = D + i[m.line].width + f, m.line++, C = m.y = o(r, t.top + v + f, t.bottom - i[m.line].height)),
                    function(t, e, i) {
                        ...
                        if (a.fillStyle = U(i.fillStyle, c), a.lineCap = U(i.lineCap, "butt"), a.lineDashOffset = U(i.lineDashOffset, 0), a.lineJoin = U(i.lineJoin, "miter"), a.lineWidth = n, a.strokeStyle = U(i.strokeStyle, c), a.setLineDash(U(i.lineDash, [])), l.usePointStyle) {
                            const o = {
                            ...
                            const o = e + Math.max((g - b) / 2, 0),
                                s = h.leftForLtr(t, x),
                                r = Le(i.borderRadius);
                            a.beginPath(), Object.values(r).some(t => 0 !== t) ? Jt(a, {
                                x: s,
                                y: o,
                                w: x,
                                h: b,
        ...
        drawTitle() {
            ...
            const p = o(c, f, f + g);
            l.textAlign = r.textAlign(n(c)), l.textBaseline = "middle", l.strokeStyle = i.color, l.fillStyle = i.color, l.font = s.string, Qt(l, i.text, p, u, s)
        }
        _computeTitleHeight() {
        ...
        handleEvent(t) {
            ...
            if ("mousemove" === t.type) {
                ...
                a && !r && K(i.onLeave, [t, a, e], e), e._hoveredItem = n, n && !r && K(i.onHover, [t, n, e], e)
    ...
    class os extends Ti {
        ...
        _drawArgs(t) {
            ...
            let l, c, h, d = 0;
            return this.isHorizontal() ? (c = o(r, i, s), h = e + t, l = s - i) : ("left" === a.position ? (c = i + t, h = o(r, n, e), d = -.5 * pt) : (c = s - t, h = o(r, e, n), d = .5 * pt), l = n - e), {
                titleX: c,
                titleY: h,
                maxWidth: l,
                rotation: d
    ...
    function hs(t, e) {
        ...
        x += t.beforeBody.length + t.afterBody.length, d && (p += d * c.lineHeight + (d - 1) * e.titleSpacing + e.titleMarginBottom), x && (p += f * (e.displayColors ? Math.max(r, l.lineHeight) : l.lineHeight) + (x - f) * l.lineHeight + (x - 1) * e.bodySpacing), u && (p += e.footerMarginTop + u * h.lineHeight + (u - 1) * e.footerSpacing);
        let b = 0;
        const _ = function(t) {
        ...
        }), b = 0, i.font = h.string, G(t.footer, _), i.restore(), {
            width: m += g.width,
            height: p
        }
    }
    ...
    function fs(t, e, i, n) {
        ...
        return "center" === l ? "left" === r ? d += c : "right" === r && (d -= c) : "left" === r ? d -= h : "right" === r && (d += h), {
            x: Bt(d, 0, n.width - e.width),
            y: Bt(u, 0, n.height - e.height)
        }
    }
    ...
    class xs extends Ti {
        ...
        getTitle(t, e) {
            ...
            let r = [];
            return r = rs(r, ls(o)), r = rs(r, ls(s)), r = rs(r, ls(a))
        }
        getBeforeBody(t, e) {
        ...
        getBody(t, e) {
            ...
            return G(t, t => {
                const e = {
                    ...
                    s = ms(n, t);
                rs(e.before, ls(s.beforeLabel.call(i, t))), rs(e.lines, s.label.call(i, t)), rs(e.after, ls(s.afterLabel.call(i, t))), o.push(e)
            }), o
        }
        getAfterBody(t, e) {
        ...
        _createItems(t) {
            const e = this,
                ...
                a = [];
            let r, l, c = [];
            for (r = 0, l = i.length; r < l; ++r) c.push(cs(e._chart, i[r]));
            return t.filter && (c = c.filter((e, i, o) => t.filter(e, i, o, n))), t.itemSort && (c = c.sort((e, i) => t.itemSort(e, i, n))), G(c, i => {
        ...
        update(t, e) {
            ...
            let s, a = [];
            if (o.length) {
                const t = as[n.position].call(i, o, i._eventPosition);
        ...
        drawTitle(t, e, i) {
            ...
            if (s) {
                ...
                for (t.x = gs(n, i.titleAlign, i), e.textAlign = c.textAlign(i.titleAlign), e.textBaseline = "middle", a = Ee(i.titleFont), r = i.titleSpacing, e.fillStyle = i.titleColor, e.font = a.string, l = 0; l < s; ++l) e.fillText(o[l], c.x(t.x), t.y + a.lineHeight / 2), t.y += a.lineHeight + r, l + 1 === s && (t.y += i.titleMarginBottom - r)
            }
        }
        _drawColorBox(t, e, i, n, o) {
            ...
            if (o.usePointStyle) {
                const e = {
                    ...
                    s = g + l / 2;
                t.strokeStyle = o.multiKeyBackground, t.fillStyle = o.multiKeyBackground, Ut(t, e, i, s), t.strokeStyle = a.borderColor, t.fillStyle = a.backgroundColor, Ut(t, e, i, s)
            } else {
                ...
                const e = n.leftForLtr(u, c),
                    ...
                    s = Le(a.borderRadius);
                Object.values(s).some(t => 0 !== t) ? (t.beginPath(), t.fillStyle = o.multiKeyBackground, Jt(t, {
                    x: e,
                    y: g,
                    w: c,
                    h: l,
        ...
        drawBody(t, e, i) {
            ...
            const f = fn(i.rtl, n.x, n.width),
                ...
                p = f.textAlign(a);
            let m, x, b, _, y, v, w;
            for (e.textAlign = a, e.textBaseline = "middle", e.font = h.string, t.x = gs(n, p, i), e.fillStyle = i.bodyColor, G(n.beforeBody, g), u = r && "right" !== p ? "center" === a ? c / 2 + 1 : c + 2 : 0, _ = 0, v = o.length; _ < v; ++_) {
                for (m = o[_], x = n.labelTextColors[_], e.fillStyle = x, G(m.before, g), b = m.lines, r && b.length && (n._drawColorBox(e, t, _, f, i), d = Math.max(h.lineHeight, l)), y = 0, w = b.length; y < w; ++y) g(b[y]), d = h.lineHeight;
                G(m.after, g)
            }
            u = 0, d = h.lineHeight, G(n.afterBody, g), t.y -= s
        }
        drawFooter(t, e, i) {
            const n = this,
                o = n.footer,
            ...
            if (s) {
                ...
                for (t.x = gs(n, i.footerAlign, i), t.y += i.footerMarginTop, e.textAlign = l.textAlign(i.footerAlign), e.textBaseline = "middle", a = Ee(i.footerFont), e.fillStyle = i.footerColor, e.font = a.string, r = 0; r < s; ++r) e.fillText(o[r], l.x(t.x), t.y + a.lineHeight / 2), t.y += a.lineHeight + i.footerSpacing
            }
        }
        ...
        _updateAnimationTarget(t) {
            const e = this,
                ...
                s = n && n.y;
            if (o || s) {
                const n = as[t.position].call(e, e._active, e._eventPosition);
                if (!n) return;
                const a = e._size = hs(e, t),
        ...
        handleEvent(t, e) {
            ...
            return (s = e || !Z(a, o) || r) && (i._active = a, (n.enabled || n.external) && (i._eventPosition = {
                x: t.x,
                y: t.y
            }, i.update(!0, e))), s
        }
        _positionChanged(t, e) {
            const {
                ...
                caretY: n,
                options: o
            } = this, s = as[o.position].call(this, t, e);
    ...
    class ys extends Ni {
        ...
        parse(t, e) {
            ...
            return ((t, e) => null === t ? null : Bt(Math.round(t), 0, e))(e = isFinite(e) && i[e] === t ? e : function(t, e, i) {
                const n = t.indexOf(e);
                return -1 === n ? ((t, e, i) => "string" == typeof e ? t.push(e) - 1 : isNaN(e) ? null : i)(t, e, i) : n !== t.lastIndexOf(e) ? i : n
            }(i, t, U(e, t)), i.length - 1)
        }
        determineDataLimits() {
            const t = this,
                {
    ...
    class ws extends Ni {
        ...
        parse(t, e) {
            return H(t) || ("number" == typeof t || t instanceof Number) && !isFinite(+t) ? null : +t
        }
        ...
        buildTicks() {
            ...
            const o = function(t, e) {
                const i = [],
                    ...
                    b = !H(l),
                    _ = (p - g) / (h + 1);
                let y, v, w, M, k = St((p - g) / f / u) * u;
                if (k < 1e-14 && !m && !x) return [{
                    value: g
                }, {
                    value: p
                }];
                (M = Math.ceil(p / k) - Math.floor(g / k)) > f && (k = St(M * k / f / u) * u), H(r) || (y = Math.pow(10, r), k = Math.ceil(k * y) / y), "ticks" === n ? (v = Math.floor(g / k) * k, w = Math.ceil(p / k) * k) : (v = g, w = p), m && x && o && Ot((a - s) / o, k / 1e3) ? (k = (a - s) / (M = Math.min((a - s) / k, c)), v = s, w = a) : b ? k = ((w = x ? a : w) - (v = m ? s : v)) / (M = l - 1) : M = Ct(M = (w - v) / k, Math.round(M), k / 1e3) ? Math.round(M) : Math.ceil(M);
                const S = Math.max(Rt(k), Rt(v));
                y = Math.pow(10, H(r) ? S : r), v = Math.round(v * y) / y, w = Math.round(w * y) / y;
                let P = 0;
                for (m && (d && v !== s ? (i.push({
                        value: s
                    }), v < s && P++, Ct(Math.round((v + P * k) * y) / y, s, vs(s, _, t)) && P++) : v < s && P++); P < M; ++P) i.push({
                    value: Math.round((v + P * k) * y) / y
                });
                return x && d && w !== a ? Ct(i[i.length - 1].value, a, vs(a, _, t)) ? i[i.length - 1].value = a : i.push({
                    value: a
                }) : x && w !== a || i.push({
                    value: w
                }), i
            ...
            return "ticks" === e.bounds && Tt(o, t, "value"), e.reverse ? (o.reverse(), t.start = t.max, t.end = t.min) : (t.start = t.min, t.end = t.max), o
        }
        configure() {
            const t = this,
                e = t.ticks;
    ...
    class Ms extends ws {
        determineDataLimits() {
            ...
            t.min = $(e) ? e : 0, t.max = $(i) ? i : 1, t.handleTickRangeOptions()
        }
        computeTickLimit() {
            const t = this,
                e = t.isHorizontal(),
                i = e ? t.width : t.height,
                n = At(t.options.ticks.minRotation),
    ...
    class Ss extends Ni {
        ...
        determineDataLimits() {
            ...
            t.min = $(e) ? Math.max(0, e) : null, t.max = $(i) ? Math.max(0, i) : null, t.options.beginAtZero && (t._zero = !0), t.handleTickRangeOptions()
        }
        handleTickRangeOptions() {
            const t = this,
                {
        ...
        buildTicks() {
            const t = this,
                ...
                i = function(t, e) {
                    const i = Math.floor(Mt(e.max)),
                        ...
                        o = [];
                    let s = Y(t.min, Math.pow(10, Math.floor(Mt(e.min)))),
                        a = Math.floor(Mt(s)),
            ...
            return "ticks" === e.bounds && Tt(i, t, "value"), e.reverse ? (i.reverse(), t.start = t.max, t.end = t.min) : (t.start = t.min, t.end = t.max), i
        }
        getLabelForValue(t) {
        ...
        getPixelForValue(t) {
            const e = this;
            return void 0 !== t && 0 !== t || (t = e.min), null === t || isNaN(t) ? NaN : e.getPixelForDecimal(t === e.min ? 0 : (Mt(t) - e._startValue) / e._valueRange)
        }
        getValueForPixel(t) {
            const e = this,
    ...
    function Ps(t) {
        ...
        if (e.display && t.display) {
            ...
            return U(e.font && e.font.size, gt.font.size) + t.height
        }
        return 0
    }
    ...
    class Ls extends ws {
        ...
        setDimensions() {
            const t = this;
            t.width = t.maxWidth, t.height = t.maxHeight, t.paddingTop = Ps(t.options) / 2, t.xCenter = Math.floor(t.width / 2), t.yCenter = Math.floor((t.height - t.paddingTop) / 2), t.drawingArea = Math.min(t.height - t.paddingTop, t.width) / 2
        }
        determineDataLimits() {
            const t = this,
                {
            ...
            t.min = $(e) && !isNaN(e) ? e : 0, t.max = $(i) && !isNaN(i) ? i : 0, t.handleTickRangeOptions()
        }
        computeTickLimit() {
        ...
        fit() {
            ...
            e.display && e.pointLabels.display ? function(t) {
                ...
                for (n = 0; n < l; n++) {
                    ...
                    const u = Ee(l.font);
                    t.ctx.font = u.string, c = t.ctx, h = u.lineHeight, o = N(d = t._pointLabels[n]) ? {
                        w: jt(c, c.font, d),
                        h: d.length * h
                    } : {
                    ...
                    const f = t.getIndexAngle(n),
                        g = Lt(f),
                        p = Ds(g, s.x, o.w, 0, 180),
                        m = Ds(g, s.y, o.h, 90, 270);
                ...
                for (n = 0; n < l; n++) {
                    ...
                    const l = Cs(o);
                    let c;
                    const h = (c = "left" === l ? i.x : "center" === l ? i.x - s.w / 2 : i.x - s.w) + s.w;
        ...
        getIndexAngle(t) {
            return Ft(t * (mt / this.getLabels().length) + At(this.options.startAngle || 0))
        }
        ...
        drawBackground() {
            ...
            if (e) {
                const n = t.ctx;
                n.save(), n.beginPath(), Ts(t, t.getDistanceFromCenterForValue(t._endValue), i, t.getLabels().length), n.closePath(), n.fillStyle = e, n.fill(), n.restore()
            }
        }
        drawGrid() {
            const t = this,
            ...
            if (i.pointLabels.display && function(t, e) {
                    ...
                    if (0 !== i) {
                        ...
                        ! function(t, e, i, n) {
                            ...
                            !s && !n || !a || !r || i < 0 || (o.save(), o.strokeStyle = a, o.lineWidth = r, o.setLineDash(e.borderDash), o.lineDashOffset = e.borderDashOffset, o.beginPath(), Ts(t, i, s, n), o.closePath(), o.stroke(), o.restore())
                        }(t, n, r, s)
                    }
                }), n.display) {
    ...
    Ls.id = "radialLinear", Ls.defaults = {
        display: !0,
        animate: !0,
        position: "chartArea",
        angleLines: {
    ...
    function zs(t, e) {
        ...
        let a = e;
        return "function" == typeof n && (a = n(a)), $(a) || (a = "string" == typeof n ? i.parse(a, n) : i.parse(a)), null === a ? null : (o && (a = "week" !== o || !Dt(s) && !0 !== s ? i.startOf(a, o) : i.startOf(a, "isoWeek", s)), +a)
    }

    function Fs(t, e, i, n) {
        const o = Es.length;
        for (let s = Es.indexOf(t); s < o - 1; ++s) {
            const t = Rs[Es[s]],
                o = t.steps ? t.steps : Number.MAX_SAFE_INTEGER;
            if (t.common && Math.ceil((i - e) / (o * t.size)) <= n) return Es[s]
        }
        return Es[o - 1]
    }
    ...
    class Ws extends Ni {
        ...
        init(t, e) {
            ...
            it(i.displayFormats, n.formats()), this._parseOpts = {
                parser: i.parser,
                round: i.round,
        ...
        parse(t, e) {
            return void 0 === t ? null : zs(this, t)
        }
        beforeLayout() {
        ...
        determineDataLimits() {
            ...
            a && r || (l(t._getLabelBounds()), "ticks" === e.bounds && "labels" === e.ticks.source || l(t.getMinMax(!1))), o = $(o) && !isNaN(o) ? o : +i.startOf(Date.now(), n), s = $(s) && !isNaN(s) ? s : +i.endOf(Date.now(), n) + 1, t.min = Math.min(o, s - 1), t.max = Math.max(o + 1, s)
        }
        _getLabelBounds() {
        ...
        buildTicks() {
            ...
            const s = t.min,
                a = ne(o, s, t.max);
            return t._unit = i.unit || (n.autoSkip ? Fs(i.minUnit, t.min, t.max, t._getLabelCapacity(s)) : function(t, e, i, n, o) {
                for (let s = Es.length - 1; s >= Es.indexOf(i); s--) {
                    const i = Es[s];
                    if (Rs[i].common && t._adapter.diff(o, n, i) >= e - 1) return i
                }
                ...
                for (let e = Es.indexOf(t) + 1, i = Es.length; e < i; ++e)
                    if (Rs[Es[e]].common) return Es[e]
            }(t._unit) : void 0, t.initOffsets(o), e.reverse && a.reverse(), Bs(t, a, t._majorUnit)
        }
        initOffsets(t) {
            const e = this;
            let i, n, o = 0,
            ...
            o = Bt(o, 0, a), s = Bt(s, 0, a), e._offsets = {
                start: o,
                end: s,
                factor: 1 / (o + 1 + s)
            }
        ...
        _generate() {
            ...
            for (d = f, u = 0; d < n; d = +e.add(d, r, a), u++) Vs(h, d, g);
            return d !== n && "ticks" !== o.bounds && 1 !== u || Vs(h, d, g), Object.keys(h).sort((t, e) => t - e).map(t => +t)
        }
        getLabelForValue(t) {
        ...
        _getLabelSize(t) {
            const e = this,
                ...
                o = At(e.isHorizontal() ? i.maxRotation : i.minRotation),
                s = Math.cos(o),
                a = Math.sin(o),
        ...
        _getLabelCapacity(t) {
            const e = this,
                ...
                s = e._tickFormatFunction(t, 0, Bs(e, [t], e._majorUnit), o),
                a = e._getLabelSize(s),
        ...
        getLabelTimestamps() {
            ...
            const o = t.getLabels();
            for (i = 0, n = o.length; i < n; ++i) e.push(zs(t, o[i]));
    ...
    class Ns extends Ws {
        ...
        buildLookupTable(t) {
            ...
            const n = [e];
            let o, s, a;
            for (o = 0, s = t.length; o < s; ++o)(a = t[o]) > e && a < i && n.push(a);
            return n.push(i), n
        }
        ...
        getPixelForValue(t, e) {
            const i = this,
                n = i._offsets,
                o = i._normalized && i._maxIndex > 0 && !H(e) ? e / i._maxIndex : i.getDecimalForValue(t);
            return i.getPixelForDecimal((n.start + o) * n.factor)
        }
        getDecimalForValue(t) {
            return Hs(this._table, t) / this._maxIndex
        }
        getValueForPixel(t) {
            const e = this,
                i = e._offsets,
                n = e.getDecimalForPixel(t) / i.factor - i.end;
            return Hs(e._table, n * this._maxIndex, !0)
        }
    }
    Ns.id = "timeseries", Ns.defaults = Ws.defaults;
    ...
    return Kn.register(fo, js, zo, _s), Kn.helpers = {...kn
    }, Kn._adapters = Jn, Kn.Animation = pi, Kn.Animations = xi, Kn.animator = a, Kn.controllers = Pn.controllers.items, Kn.DatasetController = Oi, Kn.Element = Ti, Kn.elements = zo, Kn.Interaction = Pe, Kn.layouts = Xe, Kn.platforms = li, Kn.Scale = Ni, Kn.Ticks = Ei, Object.assign(Kn, fo, js, zo, _s, li), Kn.Chart = Kn, "undefined" != typeof window && (window.Chart = Kn), Kn
});